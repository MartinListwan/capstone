...
public class QuickAnswerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof QuickViewHolder) {
            ...
            quickViewHolder.quickAnswerText.setTextIsSelectable(true);
            quickViewHolder.quickAnswerText.setVerticalScrollBarEnabled(true);
            quickViewHolder.quickAnswerText.getParent().requestDisallowInterceptTouchEvent(true);
        } else{
            // TODO, make a loading view
            throw new IllegalStateException("Viewtype is unknown");
        }
