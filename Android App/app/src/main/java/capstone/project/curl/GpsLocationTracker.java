...
public class GpsLocationTracker extends Service implements LocationListener {
    ...
    private static String [] permission = {Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};


    /**
     * @param mContext constructor of the class
     */
    public GpsLocationTracker(Context mContext, Activity activity) {
